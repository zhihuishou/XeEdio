...
async def mix_page(request: Request):
    ...
    return templates.TemplateResponse("mix_chat.html", {"request": request})


@router.get("/admin/config", response_class=HTMLResponse)
async def admin_config_page(request: Request):
    """System configuration page (Admin only)."""
    return templates.TemplateResponse("admin_config.html", {"request": request})
...
async def admin_forbidden_words_page(request: Request):
    ...
    return templates.TemplateResponse("admin_forbidden_words.html", {"request": request})
